...
public class EuiccDetailsActivity extends AppCompatActivity {
    ...
    private TextView textViewEuiccRspCapability;
    ...
    private void attachUi() {
        ...
        textViewEuiccRspCapability = findViewById(R.id.text_rsp_capability);
        ...
        textViewEuiccRspCapability.setText("");
    ...
    private void setEuiccInfo(EuiccInfo euiccInfo) {
        ...
        textViewEuiccRspCapability.setText(euiccInfo.getEuiccRspCapability());
